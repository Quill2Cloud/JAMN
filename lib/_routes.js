...
Controllers.UserProfile = RouteController.extend({
  //
});

Controllers.UserSongs = Controllers.UserProfile.extend({
  //
});

Controllers.SignOut = RouteController.extend({
  onBeforeAction: function() {
...
Router.map(function(){
  ...
  this.route('/privacy-policy', {name: 'privacy', template: 'privacy'});
  this.route('/terms-and-conditions', {name: 'terms', template: 'terms'});
  ...
  this.route('/users/:slug', {name: 'user',template: 'user', controller: Controllers.UserSongs});

  this.route('/sign-out', {name: 'sign-out',template: '_loading', controller: Controllers.SignOut});
